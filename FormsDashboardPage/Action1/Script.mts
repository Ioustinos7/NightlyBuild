'Declare the variables
	Dim strUserName, strPass, intRowCount, intLoop, strExecute, strFormName1 @@ script infofile_;_ZIP::ssf8.xml_;_
...
'verify you can click the 'view form' link @@ script infofile_;_ZIP::ssf11.xml_;_
...
'close the sign forms tab
	Browser("SignForms - Client Admin").Close @@ hightlight id_;_788812_;_script infofile_;_ZIP::ssf13.xml_;_
...
'Check the 'add/edit forms' link to see that it takes you to your account
	...
	Browser("SignForms - Client Admin").Page("SignForms - Client Admin").WebElement("Manage your forms").Check CheckPoint("Manage your forms") @@ script infofile_;_ZIP::ssf16.xml_;_
